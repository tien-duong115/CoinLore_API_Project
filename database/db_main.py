...
from create_table_sql import drop_table_queries, create_table_queries, copy_coins_data_to_redshift
...
local_dbname=os.getenv('postgres')
...
def load_staging_tables(cur, conn):
    ...
    cur.execute(copy_coins_data_to_redshift)
    conn.commit()
